...
public class XmppServer {
        ...
        try {
          ...
          //  locateServer();
            serverName = Config.getString("xmpp.domain", "127.0.0.1")
                    .toLowerCase();
            context = new ClassPathXmlApplicationContext("xmpp-config.xml");
    ...
    public SessionManager getSessionManager(){
    	return (SessionManager) this.context.getBean(SESSION_MANAGER,SessionManager.class);
    }
    /**
     * Stops the server.
     */
    ...
    private void shutdownServer() {
        ...
        getSessionManager().closeAllSessions();
