...
public class StanzaHandler {
	 ...
	 *            the connection
	 */
	public StanzaHandler(PacketRouter router, String serverName,
	 ...
	 * handles stanzas.
	 * 
	 * Note that the value that is returned for this method can change over
	 * time. For example, if no session has been established yet, this method
	 * will return <tt>null</tt>, or, if resource binding occurs, the returned
	 * value might change. Values obtained from this method are therefore best
	 * <em>not</em> cached.
	 * 
