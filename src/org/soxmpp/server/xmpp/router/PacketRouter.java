...
public class PacketRouter {
	...
	private Router presenceRouter;

	private Router iqRouter;
	...
	public void setMessageRouter(Router messageRouter) {
		this.messageRouter = messageRouter;
	}

	public void setPresenceRouter(Router presenceRouter) {
		this.presenceRouter = presenceRouter;
	}

	public void setIqRouter(Router iqRouter) {
